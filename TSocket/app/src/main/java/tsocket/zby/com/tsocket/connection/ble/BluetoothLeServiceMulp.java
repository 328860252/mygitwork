...
//			try {
//				String address=  gatt.getDevice().getAddress();
//				Log.w("tag", gatt.getDevice().getAddress()+"   ���͵Ļ�ִ���͹㲥" + status);
...
//		MyLog.e("tag_send",address+ "  ����  " + "  "+ status + " " + Myhex.buffer2String(bb));
...
//						}
//
//						MyLog.v("tag_send", address+"  ���·��ͷ���  " + status + " " + Myhex.buffer2String(lastBuffer));
//					}
...
////						Log.d(TAG,"���������豸 all: " +Myhex.buffer2String(arg2));
////						Log.d(TAG,"���������豸 : " +Myhex.buffer2String(namebuff));
//						Log.w(TAG,"���������豸: " +name + " " + arg0.getAddress() );
...
////			try {
////				name= new String(nameBuff, AppConstants.CharSet);
////				Log.d(TAG,"���������豸: " +name + " " + arg0.getAddress() + " " +arg1 + " �㲥����"+Myhex.buffer2String(bf));
////			} catch (UnsupportedEncodingException e) {
////				// TODO Auto-generated catch block
////				e.printStackTrace();
////			}
...
////		if(scanSet.contains(device.getAddress()) || (onOff!=0x11 && onOff!=0x1F)) {//����
////			return;
////		}
...
////		if(scanSet.contains(device.getAddress()) ) {//����
////			return;
////		}
//		Intent intent = new Intent(ACTION_BLUETOOTH_FOUND);
//		intent.putExtra("mac", device.getAddress());
